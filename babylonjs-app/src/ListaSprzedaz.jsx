...
const ListaSprzedaz = [
    ...
    },
    {
      ...
      plname: "Plakat1",
      enname: "Poster1",
      pldescription: "Kompletnie wy kamienicy, okna w mieszkaniu są skierowane na Rynek Główny. W miszkaniu znajdziecie Państwo: suszarke do włosów, zestaw ręczników, mydło, humidifier, centralne ogrzewanie, pralkę, płytę grzewczą, zmywarkę, czajnik, ekspres do kawy przelewowy, mikrofalówkę, zastawę",
      endescription: "A fully equipof the tenement house, the windows in the apartment are facing the Main Square. In the apartment you will find: a hair dryer, a set of towels, soap, humidifier, central heating, washing machine, hob, dishwasher, kettle, filter coffee maker, microwave, tableware",
      cena: "1123 "
    },
    {
      id: "p4",autor: "jan jan",
      ...
      plname: "Plakat1",
      enname: "Poster1",
      pldescription: "Komplicy, okna w mieszkaniu są skierowane na Rynek Główny. W miszkaniu znajdziecie Państwo: suszarke do włosów, zestaw ręczników, mydło, humidifier, centralne ogrzewanie, pralkę, płytę grzewczą, zmywarkę, czajnik, ekspres do kawy przelewowy, mikrofalówkę, zastawę",
      endescription: "A fultenement house, the windows in the apartment are facing the Main Square. In the apartment you will find: a hair dryer, a set of towels, soap, humidifier, central heating, washing machine, hob, dishwasher, kettle, filter coffee maker, microwave, tableware",
      cena: "5123 "
    },
    {
      id: "p5",autor: "jan jan",
