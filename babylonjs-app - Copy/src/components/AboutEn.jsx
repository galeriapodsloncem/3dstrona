...
import OpisKamienicy from '../data/OpisKamienicy.json';
import OpisKamienicyEn from '../data/OpisKamienicyEn.json';
...
Kamienica położona jest na linii AB, z południową ekspozycją. Elewacja kamienica została wyremontowana w 2008 roku.fdgdgfdg      </span>
    </Card>
  </Col>
  <Col
    m={1}
